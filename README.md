...
**Esenef Tools / Digital Seller Assistant** adalah web app ringan untuk membantu pemula menyusun strategi promosi produk dari nol. User cukup masukin nama produk, lalu tools akan membuat paket promosi siap pakai: analisis produk, target audiens, angle, hook, caption, CTA, script video, balasan DM, dan rencana posting 5 hari.

Branding: **by esenef17**.

## Fungsi Utama

Tools ini dibuat untuk pemula yang bukan cuma butuh caption, tapi butuh dibantu mikirin arah jualannya.

Masalah yang dibantu:

- Produk ini cocok dijual ke siapa?
- Masalah audiensnya apa?
- Angle promosi yang masuk akal apa?
...
```text
Masukin nama produk → generate → keluar paket konten siap posting
```
...
3. Biarkan **Jenis produk** di mode otomatis, atau pilih kategori manual.
4. Pilih platform, gaya konten, dan level user jika ingin hasil lebih spesifik.
5. Klik **Generate Paket Promosi**.
6. Tunggu loading singkat saat tools menyusun angle jualan.
7. Copy bagian yang dibutuhkan, atau klik **Copy Semua** untuk menyalin seluruh paket.

Kalau user cuma isi nama produk saja, tools tetap bisa menghasilkan paket lengkap. Generator akan mencoba menebak kategori dari nama produk.

## Fitur Utama

### 1. Buat Paket Promosi Lengkap

Satu form sederhana untuk membuat strategi promosi siap pakai. Input wajib hanya nama produk, sedangkan input lain opsional.

Input yang tersedia:

- Nama produk.
- Jenis produk:
  - Tebak otomatis dari nama produk.
  - Produk Digital.
  - Affiliate Shopee.
  - TikTok Shop.
  - Fashion.
...
Tools membuat 10 hook yang natural, relate, dan tidak terlalu formal.
...
Caption dibuat casual, tidak terlalu panjang, dan cocok untuk pemula.
...
Tools membuat 3 script video pendek untuk TikTok, Reels, atau Shopee Video.
...
Jika jenis produk memakai mode otomatis, tools menebak konteks dari nama produk. Misalnya nama produk mengandung `sunscreen`, arahnya dibuat seperti skincare; jika mengandung `rice cooker`, arahnya dibuat seperti alat rumah.
